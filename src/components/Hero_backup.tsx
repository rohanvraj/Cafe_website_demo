          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <div className="relative bg-gradient-to-br from-blue-100 to-teal-100 rounded-2xl p-8 shadow-2xl">
                <Swiper
  className="w-full h-96 border-4 border-red-500"
  effect="coverflow"
  grabCursor={true}
  centeredSlides={true}
  slidesPerView="auto"
...
>
  <SwiperSlide className="w-64 h-96 rounded-xl overflow-hidden shadow-lg">
    <img
      src="https://images.pexels.com/photos/8460154/pexels-photo-8460154.jpeg?auto=compress&cs=tinysrgb&w=800"
  ...
  <SwiperSlide className="w-64 h-96 rounded-xl overflow-hidden shadow-lg">
    <img
      src="https://images.pexels.com/photos/8460045/pexels-photo-8460045.jpeg?auto=compress&cs=tinysrgb&w=800"
      className="w-full h-full object-cover"
  ...
  <SwiperSlide className="w-64 h-96 rounded-xl overflow-hidden shadow-lg">
    <img
      src="https://images.pexels.com/photos/8376275/pexels-photo-8376275.jpeg?auto=compress&cs=tinysrgb&w=800"
      className="w-full h-full object-cover"
  ...
  <SwiperSlide className="w-64 h-96 rounded-xl overflow-hidden shadow-lg">
    <img
      src="https://images.pexels.com/photos/7583384/pexels-photo-7583384.jpeg?auto=compress&cs=tinysrgb&w=800"
      className="w-full h-full object-cover"
      alt="Healthcare Team"
    />
  </SwiperSlide>
